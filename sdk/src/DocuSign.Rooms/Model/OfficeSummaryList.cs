...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class OfficeSummaryList :  IEquatable<OfficeSummaryList>, IValidatableObject
    {
        ...
        public OfficeSummaryList(List<OfficeSummary> OfficeSummaries = default(List<OfficeSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
