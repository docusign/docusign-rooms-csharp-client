...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OfficeSummaryList :  IEquatable<OfficeSummaryList>, IValidatableObject
    {
        public OfficeSummaryList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="OfficeSummaryList" /> class.
        /// </summary>
        ...
        public OfficeSummaryList(List<OfficeSummary> OfficeSummaries = default(List<OfficeSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
        ...
        /// </summary>
        [DataMember(Name="officeSummaries", EmitDefaultValue=false)]
        public List<OfficeSummary> OfficeSummaries { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OfficeSummaries: ").Append(OfficeSummaries).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OfficeSummaryList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(OfficeSummaryList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.OfficeSummaries == other.OfficeSummaries ||
                    this.OfficeSummaries != null &&
                    this.OfficeSummaries.SequenceEqual(other.OfficeSummaries)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OfficeSummaries != null)
                    hash = hash * 59 + this.OfficeSummaries.GetHashCode();
