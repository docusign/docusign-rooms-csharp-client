...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class RoomSummaryList :  IEquatable<RoomSummaryList>, IValidatableObject
    {
        ...
        public RoomSummaryList(List<RoomSummary> Rooms = default(List<RoomSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
            this.Rooms = Rooms;
