...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskListTemplateList :  IEquatable<TaskListTemplateList>, IValidatableObject
    {
        public TaskListTemplateList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="TaskListTemplateList" /> class.
        /// </summary>
        ...
        public TaskListTemplateList(List<TaskListTemplate> TaskListTemplates = default(List<TaskListTemplate>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
        ...
        /// </summary>
        [DataMember(Name="taskListTemplates", EmitDefaultValue=false)]
        public List<TaskListTemplate> TaskListTemplates { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TaskListTemplates: ").Append(TaskListTemplates).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaskListTemplateList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TaskListTemplateList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.TaskListTemplates == other.TaskListTemplates ||
                    this.TaskListTemplates != null &&
                    this.TaskListTemplates.SequenceEqual(other.TaskListTemplates)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TaskListTemplates != null)
                    hash = hash * 59 + this.TaskListTemplates.GetHashCode();
