...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class TaskListTemplateList :  IEquatable<TaskListTemplateList>, IValidatableObject
    {
        ...
        public TaskListTemplateList(List<TaskListTemplate> TaskListTemplates = default(List<TaskListTemplate>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
