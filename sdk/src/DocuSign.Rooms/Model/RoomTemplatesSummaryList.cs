...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoomTemplatesSummaryList :  IEquatable<RoomTemplatesSummaryList>, IValidatableObject
    {
        public RoomTemplatesSummaryList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RoomTemplatesSummaryList" /> class.
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name="roomTemplates", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RoomTemplates: ").Append(RoomTemplates).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RoomTemplatesSummaryList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RoomTemplatesSummaryList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.RoomTemplates == other.RoomTemplates ||
                    this.RoomTemplates != null &&
                    this.RoomTemplates.SequenceEqual(other.RoomTemplates)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RoomTemplates != null)
                    hash = hash * 59 + this.RoomTemplates.GetHashCode();
