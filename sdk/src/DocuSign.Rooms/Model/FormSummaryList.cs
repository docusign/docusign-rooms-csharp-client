...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class FormSummaryList :  IEquatable<FormSummaryList>, IValidatableObject
    {
        ...
        public FormSummaryList(List<FormSummary> Forms = default(List<FormSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
            this.Forms = Forms;
