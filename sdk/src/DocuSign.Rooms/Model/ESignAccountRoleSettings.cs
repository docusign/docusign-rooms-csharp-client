...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ESignAccountRoleSettings :  IEquatable<ESignAccountRoleSettings>, IValidatableObject
    {
        public ESignAccountRoleSettings()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ESignAccountRoleSettings" /> class.
        /// </summary>
        /// <param name="AllowAccountManagement">AllowAccountManagement.</param>
        public ESignAccountRoleSettings(bool? AllowAccountManagement = default(bool?))
        {
        ...
        public bool? AllowAccountManagement { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ESignAccountRoleSettings);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ESignAccountRoleSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
