...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class UserSummaryList :  IEquatable<UserSummaryList>, IValidatableObject
    {
        ...
        public UserSummaryList(List<UserSummary> UserSummaries = default(List<UserSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
