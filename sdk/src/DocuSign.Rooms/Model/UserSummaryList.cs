...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserSummaryList :  IEquatable<UserSummaryList>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserSummaryList" /> class.
        /// </summary>
        ...
        public UserSummaryList(List<UserSummary> UserSummaries = default(List<UserSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
        ...
        /// </summary>
        [DataMember(Name="userSummaries", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UserSummaries: ").Append(UserSummaries).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserSummaryList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(UserSummaryList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.UserSummaries == other.UserSummaries ||
                    this.UserSummaries != null &&
                    this.UserSummaries.SequenceEqual(other.UserSummaries)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UserSummaries != null)
                    hash = hash * 59 + this.UserSummaries.GetHashCode();
