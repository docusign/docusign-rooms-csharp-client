...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class Envelope :  IEquatable<Envelope>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="ESignEnvelopeId">ESignEnvelopeId.</param>
        public Envelope(string ESignEnvelopeId = default(string))
        {
            this.ESignEnvelopeId = ESignEnvelopeId;
        }
        
        /// <summary>
        /// Gets or Sets ESignEnvelopeId
        /// </summary>
        [DataMember(Name="eSignEnvelopeId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ESignEnvelopeId: ").Append(ESignEnvelopeId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Envelope other)
        {
            ...
            return 
                (
                    this.ESignEnvelopeId == other.ESignEnvelopeId ||
                    this.ESignEnvelopeId != null &&
                    this.ESignEnvelopeId.Equals(other.ESignEnvelopeId)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ESignEnvelopeId != null)
                    hash = hash * 59 + this.ESignEnvelopeId.GetHashCode();
                return hash;
            }
        }
