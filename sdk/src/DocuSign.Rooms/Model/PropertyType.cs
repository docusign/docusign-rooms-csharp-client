...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PropertyType :  IEquatable<PropertyType>, IValidatableObject
    {
        public PropertyType()
        {
            // Empty Constructor
        ...
        public PropertyType(string PropertyTypeId = default(string), string Name = default(string))
        {
        ...
        public bool Equals(PropertyType other)
        {
            ...
            return 
                (
                    this.PropertyTypeId == other.PropertyTypeId ||
                    this.PropertyTypeId != null &&
                    this.PropertyTypeId.Equals(other.PropertyTypeId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PropertyTypeId != null)
                    hash = hash * 59 + this.PropertyTypeId.GetHashCode();
                if (this.Name != null)
