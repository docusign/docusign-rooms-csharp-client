...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class FormLibrarySummaryList :  IEquatable<FormLibrarySummaryList>, IValidatableObject
    {
        ...
        public FormLibrarySummaryList(List<FormLibrarySummary> FormsLibrarySummaries = default(List<FormLibrarySummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
