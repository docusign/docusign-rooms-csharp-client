...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FormLibrarySummaryList :  IEquatable<FormLibrarySummaryList>, IValidatableObject
    {
        public FormLibrarySummaryList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="FormLibrarySummaryList" /> class.
        /// </summary>
        ...
        public FormLibrarySummaryList(List<FormLibrarySummary> FormsLibrarySummaries = default(List<FormLibrarySummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
        ...
        /// </summary>
        [DataMember(Name="formsLibrarySummaries", EmitDefaultValue=false)]
        public List<FormLibrarySummary> FormsLibrarySummaries { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FormsLibrarySummaries: ").Append(FormsLibrarySummaries).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FormLibrarySummaryList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(FormLibrarySummaryList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.FormsLibrarySummaries == other.FormsLibrarySummaries ||
                    this.FormsLibrarySummaries != null &&
                    this.FormsLibrarySummaries.SequenceEqual(other.FormsLibrarySummaries)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FormsLibrarySummaries != null)
                    hash = hash * 59 + this.FormsLibrarySummaries.GetHashCode();
