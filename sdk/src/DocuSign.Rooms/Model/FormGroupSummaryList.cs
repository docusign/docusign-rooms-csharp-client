...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class FormGroupSummaryList :  IEquatable<FormGroupSummaryList>, IValidatableObject
    {
        ...
        public FormGroupSummaryList(List<FormGroupSummary> FormGroups = default(List<FormGroupSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
