...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoleSummaryList :  IEquatable<RoleSummaryList>, IValidatableObject
    {
        public RoleSummaryList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RoleSummaryList" /> class.
        /// </summary>
        ...
        public RoleSummaryList(List<RoleSummary> Roles = default(List<RoleSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
            this.Roles = Roles;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RoleSummaryList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RoleSummaryList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
