...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class RoleSummaryList :  IEquatable<RoleSummaryList>, IValidatableObject
    {
        ...
        public RoleSummaryList(List<RoleSummary> Roles = default(List<RoleSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
            this.Roles = Roles;
