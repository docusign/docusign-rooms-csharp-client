...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OfficeForCreate :  IEquatable<OfficeForCreate>, IValidatableObject
    {
        public OfficeForCreate()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="OfficeForCreate" /> class.
        /// </summary>
        ...
        public OfficeForCreate(string Name = default(string), int? RegionId = default(int?), string Address1 = default(string), string Address2 = default(string), string City = default(string), string StateId = default(string), string PostalCode = default(string), string CountryId = default(string), string TimeZoneId = default(string), string Phone = default(string))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for OfficeForCreate and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OfficeForCreate);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(OfficeForCreate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
