...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FormProviderAssociationsSummaryList :  IEquatable<FormProviderAssociationsSummaryList>, IValidatableObject
    {
        public FormProviderAssociationsSummaryList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="FormProviderAssociationsSummaryList" /> class.
        /// </summary>
        /// <param name="FormProviderAssociations">FormProviderAssociations.</param>
        ...
        public FormProviderAssociationsSummaryList(List<FormProviderAssociationSummary> FormProviderAssociations = default(List<FormProviderAssociationSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
        ...
        /// <summary>
        /// Gets or Sets FormProviderAssociations
        /// </summary>
        [DataMember(Name="formProviderAssociations", EmitDefaultValue=false)]
        public List<FormProviderAssociationSummary> FormProviderAssociations { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FormProviderAssociations: ").Append(FormProviderAssociations).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FormProviderAssociationsSummaryList);
        }

        /// <summary>
        /// Returns true if FormProviderAssociationsSummaryList instances are equal
        /// </summary>
        /// <param name="other">Instance of FormProviderAssociationsSummaryList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormProviderAssociationsSummaryList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.FormProviderAssociations == other.FormProviderAssociations ||
                    this.FormProviderAssociations != null &&
                    this.FormProviderAssociations.SequenceEqual(other.FormProviderAssociations)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FormProviderAssociations != null)
                    hash = hash * 59 + this.FormProviderAssociations.GetHashCode();
