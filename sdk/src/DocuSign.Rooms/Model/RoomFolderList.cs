...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class RoomFolderList :  IEquatable<RoomFolderList>, IValidatableObject
    {
        ...
        public RoomFolderList(List<RoomFolder> Folders = default(List<RoomFolder>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
