...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoomFolderList :  IEquatable<RoomFolderList>, IValidatableObject
    {
        public RoomFolderList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RoomFolderList" /> class.
        /// </summary>
        ...
        public RoomFolderList(List<RoomFolder> Folders = default(List<RoomFolder>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
        ...
        public List<RoomFolder> Folders { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RoomFolderList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RoomFolderList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
