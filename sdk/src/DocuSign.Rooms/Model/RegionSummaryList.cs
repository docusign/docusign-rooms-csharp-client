...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class RegionSummaryList :  IEquatable<RegionSummaryList>, IValidatableObject
    {
        ...
        public RegionSummaryList(List<RegionSummary> RegionSummaries = default(List<RegionSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
