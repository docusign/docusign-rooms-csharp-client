...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RegionSummaryList :  IEquatable<RegionSummaryList>, IValidatableObject
    {
        public RegionSummaryList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RegionSummaryList" /> class.
        /// </summary>
        ...
        public RegionSummaryList(List<RegionSummary> RegionSummaries = default(List<RegionSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
        ...
        /// </summary>
        [DataMember(Name="regionSummaries", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RegionSummaries: ").Append(RegionSummaries).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RegionSummaryList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RegionSummaryList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.RegionSummaries == other.RegionSummaries ||
                    this.RegionSummaries != null &&
                    this.RegionSummaries.SequenceEqual(other.RegionSummaries)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RegionSummaries != null)
                    hash = hash * 59 + this.RegionSummaries.GetHashCode();
