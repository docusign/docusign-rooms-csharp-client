...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionSide :  IEquatable<TransactionSide>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSide" /> class.
        /// </summary>
        /// <param name="TransactionSideId">TransactionSideId.</param>
        /// <param name="Name">Name.</param>
        public TransactionSide(string TransactionSideId = default(string), string Name = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TransactionSide);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSide other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
