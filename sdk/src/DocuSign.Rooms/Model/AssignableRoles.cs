...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class AssignableRoles :  IEquatable<AssignableRoles>, IValidatableObject
    {
        ...
        public AssignableRoles(int? CurrentRoleId = default(int?), List<RoleSummary> Roles = default(List<RoleSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
