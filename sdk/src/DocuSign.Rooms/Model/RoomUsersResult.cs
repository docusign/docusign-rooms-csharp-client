...
namespace DocuSign.Rooms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoomUsersResult :  IEquatable<RoomUsersResult>, IValidatableObject
    {
        public RoomUsersResult()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RoomUsersResult" /> class.
        /// </summary>
        ...
        public RoomUsersResult(List<RoomUserSummary> Users = default(List<RoomUserSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string), int? TotalRowCount = default(int?))
        {
            this.Users = Users;
        ...
        public List<RoomUserSummary> Users { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RoomUsersResult);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RoomUsersResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
