...
namespace DocuSign.Rooms.Model
{
    ...
    public partial class RoomUsersResult :  IEquatable<RoomUsersResult>, IValidatableObject
    {
        ...
        public RoomUsersResult(List<RoomUserSummary> Users = default(List<RoomUserSummary>), int? ResultSetSize = default(int?), int? StartPosition = default(int?), string NextUri = default(string), string PriorUri = default(string))
        {
            this.Users = Users;
