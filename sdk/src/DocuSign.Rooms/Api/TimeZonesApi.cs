...
namespace DocuSign.Rooms.Api
{
    ...
    public partial class TimeZonesApi : ITimeZonesApi
    {
        ...
        /// <returns></returns>
        public TimeZonesApi(ApiClient aplClient)
        {
        ...
        public ApiResponse< GlobalTimeZones > GetTimeZonesWithHttpInfo ()
        {
            ...
            {
                return new ApiResponse<GlobalTimeZones>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalTimeZones) this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(GlobalTimeZones)));
            }
            else
            {
                return new ApiResponse<GlobalTimeZones>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalTimeZones) this.ApiClient.Deserialize(localVarResponse, typeof(GlobalTimeZones)));
            }
