...
namespace DocuSign.Rooms.Api
{
    ...
    public partial class CountriesApi : ICountriesApi
    {
        ...
        /// <returns></returns>
        public CountriesApi(ApiClient aplClient)
        {
        ...
        public ApiResponse< GlobalCountries > GetCountriesWithHttpInfo ()
        {
            ...
            {
                return new ApiResponse<GlobalCountries>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalCountries) this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(GlobalCountries)));
            }
            else
            {
                return new ApiResponse<GlobalCountries>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalCountries) this.ApiClient.Deserialize(localVarResponse, typeof(GlobalCountries)));
            }
