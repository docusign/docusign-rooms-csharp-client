...
namespace DocuSign.Rooms.Api
{
    ...
    public partial class PropertyTypesApi : IPropertyTypesApi
    {
        ...
        /// <returns></returns>
        public PropertyTypesApi(ApiClient aplClient)
        {
        ...
        public ApiResponse< GlobalPropertyTypes > GetPropertyTypesWithHttpInfo ()
        {
            ...
            {
                return new ApiResponse<GlobalPropertyTypes>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalPropertyTypes) this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(GlobalPropertyTypes)));
            }
            else
            {
                return new ApiResponse<GlobalPropertyTypes>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalPropertyTypes) this.ApiClient.Deserialize(localVarResponse, typeof(GlobalPropertyTypes)));
            }
