...
namespace DocuSign.Rooms.Api
{
    ...
    public partial class TaskDateTypesApi : ITaskDateTypesApi
    {
        ...
        /// <returns></returns>
        public TaskDateTypesApi(ApiClient aplClient)
        {
        ...
        public ApiResponse< GlobalTaskDateTypes > GetTaskDateTypesWithHttpInfo ()
        {
            ...
            {
                return new ApiResponse<GlobalTaskDateTypes>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalTaskDateTypes) this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(GlobalTaskDateTypes)));
            }
            else
            {
                return new ApiResponse<GlobalTaskDateTypes>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalTaskDateTypes) this.ApiClient.Deserialize(localVarResponse, typeof(GlobalTaskDateTypes)));
            }
