...
namespace DocuSign.Rooms.Api
{
    ...
    public partial class RoomContactTypesApi : IRoomContactTypesApi
    {
        ...
        /// <returns></returns>
        public RoomContactTypesApi(ApiClient aplClient)
        {
        ...
        public ApiResponse< GlobalRoomContactTypes > GetRoomContactTypesWithHttpInfo ()
        {
            ...
            {
                return new ApiResponse<GlobalRoomContactTypes>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalRoomContactTypes) this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(GlobalRoomContactTypes)));
            }
            else
            {
                return new ApiResponse<GlobalRoomContactTypes>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (GlobalRoomContactTypes) this.ApiClient.Deserialize(localVarResponse, typeof(GlobalRoomContactTypes)));
            }
